...
*/(function(a){a.fn.roto=function(b){var c={btnPrev:".prev",btnNext:".next",direction:"h",shift_duration:200,shift_bezier:[0,0,0,1],drift_duration:1800,drift_factor:500,drift_bezier:[0,0,.3,1],bounce_duration:400,bounce_bezier:[0,.5,.5,1],pull_divisor:3,timer_interval:50,disable_transitions:!1,startOffset:0,endOffset:0,snap:!0},b=a.extend(c,b||{}),d=1e3,e=function(){try{return document.createEvent("TouchEvent"),!0}catch(a){return!1}}(),f=e?{start:"touchstart",move:"touchmove",end:"touchend"}:{start:"mousedown",move:"mousemove",end:"mouseup"},g=function(a){return e&&typeof a.originalEvent.touches!="undefined"?a.originalEvent.touches[0]:a},h=null,i=null,j=null;if(!b.disable_transitions){var k=document.body||document.documentElement,l={transform:"transform",MozTransform:"-moz-transform",WebkitTransform:"-webkit-transform"},m={transition:{prop:"transition",event:"transitionend"},MozTransition:{prop:"-moz-transition",event:"transitionend"},WebkitTransition:{prop:"-webkit-transition",event:"webkitTransitionEnd"}};for(var n in l)if(typeof k.style[n]!="undefined"){h=l[n];break}for(var n in m)if(typeof k.style[n]!="undefined"){i=m[n].prop,j=m[n].event;break}}return this.each(function(){var k={h:{measure:"Width",offsetName:"left",coOrd:"X"},v:{measure:"Height",offsetName:"top",coOrd:"Y"}},l=k[b.direction],m=a(this),n=m.find("ul").first(),o=n.find("li"),p=0,q=b.startOffset,r=0,s=0,t=-1,u=0,v=0,w=typeof m.attr("id")!==undefined?m.attr("id"):(new Date).getTime()+"",x=null,y=null,z=!1,A=!1,B=m.find(b.btnPrev),C=m.find(b.btnNext),D=null,E=function(){if(i!==null){var a={};y===null&&(y=[h," ",b.shift_duration/d,"s ease 0s"].join("")),a[i]=y,n.css(a)}},F=function(){if(i!==null){var a={};a[i]="none",n.css(a)}},G=function(c,e,f,g,h){var k=h;if(!A||i===null)k=function(){O(),h()},A=!0;if(i!==null){var l={};l[i+"-duration"]=f/d+"s",l[i+"-timing-function"]=["cubic-bezier(",b[g+"_bezier"].join(","),")"].join(""),c.css(l),c.data("animationCallback",k),c.unbind(j),c.one(j,function(){c.data("animationCallback",null),k()}),c.css(e)}else c.animate(e,f,a.bez(b[g+"_bezier"]),k)},H=function(a){if(i!==null){var b=J();F(),typeof a.data("animationCallback")=="function"&&(a.data("animationCallback")(),a.data("animationCallback",null)),n.css(I(b))}else a.stop()},I=function(a){var b={};if(h!==null){if(x===null){var c=e?"3d":"",d=c==="3d"?"(Xpx,Ypx,0px)":"(Xpx,Ypx)",f={X:"Y",Y:"X"};x=["translate",c,d.replace(f[l.coOrd],"0")].join("")}b[h]=x.replace(l.coOrd,a)}else b[l.offsetName]=a+"px";return b},J=function(){var a=n.position()[l.offsetName]-p;if(h===null)return a;var b=n.css(h),c=b.match(/\-?[0-9]+/g);if(c===null)return a;var d=l.coOrd==="X"?c[4]:c[5];return parseInt(d)},K=function(b,c){var d=q,e,f,g=c>0?o.get().reverse():o,h=o.get(0);return a.each(g,function(g,i){_el=a(i),d=-1*Math.ceil(_el.position()[l.offsetName]),h=i,c<0?(e=-1*d+_el["outer"+l.measure](!0),f=-1*b):(e=_el.prev().length>0?d+_el.prev()["outer"+l.measure](!0):d,f=b);if(d*c>=b*c||e>f)return!1}),[h,d]},L=function(b,c){var d=c<0?"next":"prev",e=K(b,c)[0],f=a(e)[d](),g=f.length>0?f:a(e);return g},M=function(a,b,c){var b=b===0?t:b;return c?-1*Math.ceil(L(a,b).position()[l.offsetName]):K(a,b)[1]},N=function(){var a=J();return a===M(a,0,!1)},O=function(){m.trigger("rotoChange",[K(J(),1)[0]]),A=!1},P=function(){u=Math.ceil(n.parent()[l.measure.toLowerCase()]()),r=Math.ceil(v-u+p+b.endOffset)*-1,b.snap&&(r=M(r,-1,!1))},Q=function(){return D===null&&(D=typeof B=="object"&&typeof B.click=="function"&&typeof C=="object"&&typeof C.click=="function"),D},R=function(){if(!Q())return;v>u-J()?C.removeAttr("disabled"):C.attr("disabled","disabled"),J()<q?B.removeAttr("disabled"):B.attr("disabled","disabled")},S=function(a){var c=0;if(z)return;z=!0,E(),t=a;var d=function(a){G(n,I(a),b.shift_duration,"shift",function(){R(),z=!1})};a<0?c=Math.max(M(J()-u,a,!1),r):c=Math.min(M(J()+u,a,!1),q),d(c)},T=function(a){var c=Math.ceil(a+s),d=u/b.pull_divisor,e;c<q&&c>r?e=c:(e=d*d-a*a+s,console.debug(e)),n.css(I(e))},U=function(){var a=W.getPointerSpeed(),c=a[0],d=a[1],e=J(),f=c*b.drift_factor*d,g=f+e;g>q?g=q:g<r?g=r:b.snap&&!N()&&(g=M(g,d,!0));if(g===e){O();return}G(n,I(g),b.drift_duration,"drift",function(){R()})},V=function(a){var c=a<0?r:q;G(n,I(c),b.bounce_duration,"bounce",function(){R()})},W=function(){var a=0,c=0,d=0,e=null,f={startCoOrd:0,endCoOrd:0};return{start:function(){d=a=c,e=window.setInterval(function(){f.startCoOrd=a,f.endCoOrd=c,a=c},b.timer_interval)},stop:function(){clearInterval(e),f.endCoOrd=c},getPointerSpeed:function(){var a=f.endCoOrd-f.startCoOrd,c=Math.abs(a),e=c/b.timer_interval,g=a===0?f.endCoOrd-d:a,h=g<=0?g===0?0:-1:1;return h!==0&&(t=h),[e,h]},setCurrentCoOrd:function(a){c=a}}}();i==="-webkit-transition"&&n.css("-webkit-backface-visibility","hidden"),m.css({overflow:"hidden",position:"relative"}),n.css({position:"relative",whiteSpace:"nowrap",padding:0,margin:0}),o.css({display:"block","float":"left",listStyle:"none"}),p=Math.ceil(J()),n.css(I(b.startOffset+p)),B.length===0&&b.btnPrev===c.btnPrev&&m.attr("id")&&(B=a("#"+m.attr("id")+"-prev"),C=a("#"+m.attr("id")+"-next")),a(window).resize(function(){u=n.parent()[l.measure.toLowerCase()](),P(),R()}),n.bind(f.start+".roto."+w,function(b){H(n),z=!1,s=J();var c=n.find("a"),d={};e||(b.preventDefault(),document.ondragstart!==undefined&&n.find("a, img").one("dragstart",function(a){a.preventDefault()}),c.length>0&&a(document).one(f.move+".roto."+w,function(b){c.one("click.roto."+w,function(a){a.preventDefault()}),a.each(c.data("events"),function(b,c){d[b]=[],a.each(c,function(a,c){d[b].push(c)})}),c.unbind(),c.bind("click.roto."+w,function(a){a.preventDefault()})})),b=g(b);var h=b["screen"+l.coOrd];W.setCurrentCoOrd(h),a(document).bind(f.move+".roto."+w,function(a){a.preventDefault(),a=g(a),W.setCurrentCoOrd(a["screen"+l.coOrd]),T(a["screen"+l.coOrd]-h)}),a(document).one(f.end,function(){W.stop(),E(),J()>q||J()<r?V(J()-q):U(),a(document).unbind(f.move+".roto."+w),!e&&c.length>0&&window.setTimeout(function(){c.unbind("click.roto."+w),a.each(d,function(b,d){a.each(d,function(a,b){c.bind(b.type+"."+b.namespace,b.data,b.handler)})})},250)}),W.start()}),Q()&&(B.click(function(){return S(1)}),C.click(function(){return S(-1)}));if(b.direction==="h")o.each(function(b,c){v+=Math.ceil(a(c)["outer"+l.measure](!0))}),n[l.measure.toLowerCase()](v+Math.ceil(v/100));else{var X=o.last();v=Math.round(a(X).position()[l.offsetName]+a(X)["outer"+l.measure](!0))}P(),R()})}})(jQuery);
